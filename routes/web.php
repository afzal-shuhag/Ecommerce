...
//Product Routes. All Routes for frontend
...
// Route::ppst('/discount/{id}', 'Frontend\CartsController@discount')->name('discount');
...
Route::get('get-districts/{id}', function($id){
  return jason_encode(App\Models\District::where('division_id', $id)->get());
});
