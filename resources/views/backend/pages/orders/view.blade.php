    ...
    <div class="content-wrapper">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="form-control" action="{{ route('admin.order.charge', $order->id) }}" method="post">
            @csrf
          ...
          <form class="form-inline" action="{{ route('admin.order.completed', $order->id) }}" method="post" style="display : inline-block!important">
            @csrf
          ...
          <form class="form-inline" action="{{ route('admin.order.paid', $order->id) }}" method="post"  style="display : inline-block!important">
            @csrf
            @if($order->is_paid)
             <input type="submit" name="" value="Cancel Payment" class="btn btn-danger">
            @else
             <input type="submit" name="" value="Complete Payment" class="btn btn-success">
            @endif
          </form>
        </div>
      </div>
